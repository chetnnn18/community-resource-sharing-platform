...
INSERT INTO items (title, description, location, image_url, price, status, approval_status, category_id, owner_id, created_at, updated_at) VALUES
('Cordless Drill Kit', '18V drill with bits, charger and safety case.', 'Block A Lobby', 'https://images.unsplash.com/photo-1504148455328-c376907d081c?auto=format&fit=crop&w=900&q=80', 0.00, 'AVAILABLE', 'APPROVED', 1, 2, NOW(6), NOW(6)),
('Large Pressure Cooker', 'Eight litre pressure cooker for gatherings and festivals.', 'Block B Security Desk', 'https://images.unsplash.com/photo-1556911220-bff31c812dba?auto=format&fit=crop&w=900&q=80', 0.00, 'AVAILABLE', 'APPROVED', 2, 3, NOW(6), NOW(6)),
('Weekend Camping Tent', 'Four-person waterproof tent with pegs and carry bag.', 'Clubhouse Store', 'https://images.unsplash.com/photo-1504851149312-7a075b496cc7?auto=format&fit=crop&w=900&q=80', 0.00, 'AVAILABLE', 'APPROVED', 4, 2, NOW(6), NOW(6));
